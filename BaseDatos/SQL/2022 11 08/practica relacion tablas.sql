...
alter table pokemoneskanto  add primary key (pokedex);
alter table mis_pokemones  add foreign key (pokedex) references pokemoneskanto(pokedex);
...
alter  table mis_pokemones 
add constraint (fk_pokemones23)
foreign key (pokedex)
references pokemoneskanto(pokedex);
...
("casata","2,5 lts"),	
("yogurt","1 lt"),	
("cereal chocolate","400gr")
;

insert into pedidos 
(fecha, monto, cliente)
values
( '2022-10-30',111 , "pedro" ),
( '2022-12-28',222 , "Juan" ),
( '2022-09-29',333 ,"Miguel" ),
( '2022-11-27',444 ,"carlos" )
;
