...
--informe anual de ganancias de las ventas
--informe anual de productos

---tabla
create database pruebaDB;

use database pruebaDB;
--------------------------------------------------------------------------
...
("leche","1000 grs",5500,7000, 8830, 5 )
;
...
values
(120, 143,'2021-01-01' ),
(2400, 2556,'2021-03-01' ),
(6000, 7200,'2021-06-01' ),
(8400, 10000,'2021-09-01' ),
(22500, 35000,'2021-12-01' )
;
